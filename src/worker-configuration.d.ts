// Generated by Wrangler by running `wrangler types` (hash: cc06a5fdb920554f1811dcbe98fe4a54)
// Runtime types generated with workerd@1.20250320.0 2025-02-14
declare namespace Cloudflare {
    interface Env {
        LOCAL_ORIGIN: null | "http://localhost:5173";
    }
}
...
declare namespace Rpc {
    ...
    type Serializable<T> =
        ...
        >
        | {
            [K in keyof T]: K extends number | string ? Serializable<T[K]>
                : never;
        }
        // Special types
        | ReadableStream<Uint8Array>
